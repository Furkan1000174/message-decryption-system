...
namespace Decoder
{
    ...
    class WorkingParams
    {
        public const string studentNumberOne = "101157"; // This must be filled.
        ...
        public const int minSendIntervalTime = 115; // min sending interval time (in msec) by the provider
        public const int maxSendIntervalTime = 200; // max sending interval time (in msec) by the provider
    }
